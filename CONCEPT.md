...
**Version:** 98.0
**Date:** 2026-07-21
> **v98:** Возраст = время от создания центриоли (часы), НЕ количество делений. Непрерывная переменная → больше мощности.
...
> **Минимальный набор маркеров:** Centrin1-GFP + SiR-Tubulin + Arl13B. **Возраст = время (часы) от момента появления центриоли** (первое детектирование Centrin1-GFP точки). **Траектория:** C. elegans — бинарная (∥/⟂). RPE1 — угол θ (0-180°). Судьба = Arl13B⁺.
...
| Z-drift during 48h | Autofocus (Knapper 2022) + reference GFP beads. Pilot 0 validates drift. **Target: <1 µm/24h at 60×.** |
...
| Power | 82% at HR≥1.35, ICC ρ=0.3, 30% competing risk. **HR≥1.35 from Anderson & Stearns 2009: 94% vs 6% cilium asymmetry → HR ≈ 15. 1.35 — conservative lower bound.** |
