...
- **Бюджет (пересчитан 17 авг):** V9-Full базовый ~$22.4K (руки 2.5K + насадки 1K + датчики 0.6K + контроллеры 0.4K + БП 0.3K + шлюз 1K + хост Mac Studio 192GB 6.4K + софт 3K + запасные 0.8K + инжиниринг 3K + 15%). **Со стерилизацией (общий комплект V7/V8/V9, ~$12.2K): ~$34.6K.** Если оставить Mac M4 Pro (уже в OS3) — ~$15.5K / ~$27.7K.
- **Дорожная карта:** V9.0 телеоперация → V9.1 полуавтоном → V9.2 автономия 72ч.
- **V9 применим ко ВСЕМ OS:** V9-Lite (OS1, 1 рука опц., LLM на малых моделях Jetson Orin NX + общий хост, ~$5-7K), V9-Standard (OS2, 2 руки, ~$11-13K), V9-Full (OS3, 2 руки + VHP/УЗ, ~$22.4K базовый / ~$34.6K со стерилизацией). Железо рук общее, разница — число рук, шлюз, LLM-хост. Развёртывание: OS1 → OS2 → OS3.
