# СВЕРХСТРОГИЙ PEER REVIEW — ARGUS-OS1 v53
...
| **ARGUS-OS1** | **$24-27K** | **✅** | **✅ 60×/1.2 NA WI** | **✅ GPLv3/CC-BY-SA** |
...
**Вывод:** Нет универсального правила. Тканеспецифичность — не weakness, а **центральный научный вопрос.** ARGUS-OS1 — первая платформа для систематического кросс-тканевого сравнения.
...
**Только первые два механизма протестированы в RPE1.** Третий (Notch) — в NPC/глии in vivo. Четвёртый (деградация) — в ESC. **ARGUS-OS1 может впервые протестировать все механизмы в единой системе (RPE1 + NPCs).**
